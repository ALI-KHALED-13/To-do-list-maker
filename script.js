...
function todoMain (){
    let input, container, addButton, themeToggle, link;
    ...
    function getElements () {
        ...
        link = document.querySelector('[rel="stylesheet"]');
    ...
    if (localStorage.darkMode) {
        if (localStorage.getItem('darkMode') == 'true') link.setAttribute('href', 'styleDark.css');                                            
    }
